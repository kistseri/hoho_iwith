    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (resultList[0]["result"] == null) {
          ...
          List<IsReportClassExistData> isReportClassExistDataList = resultList0
              .map<IsReportClassExistData>(
                  (json) => IsReportClassExistData.fromJson(json))
              .toList();
          final IsReportClassExistDataController
              isReportClassExistDataController =
              Get.put(IsReportClassExistDataController());
          isReportClassExistDataController
              .setIsReportClassExistDataList(isReportClassExistDataList);
        }
