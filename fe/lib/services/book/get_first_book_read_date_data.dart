    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (resultList[0]["result"] == null) {
          BookReadDateData bookReadDateData =
              BookReadDateData.fromJson(resultList[0]);
          final BookReadDateDataController bookReadDateDataController =
              Get.put(BookReadDateDataController());
