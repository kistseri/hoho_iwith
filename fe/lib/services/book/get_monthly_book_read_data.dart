    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (resultList[0]["result"] == null) {
          ...
          List<BookTitleData> bookTitleDataList = resultList0
              .map<BookTitleData>((json) => BookTitleData.fromJson(json))
              .toList();
          final BookTitleDataController bookTitleDataController =
              Get.put(BookTitleDataController());
